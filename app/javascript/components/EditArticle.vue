<template>
  <form class="article-form" @submit.prevent>
    <v-text-field
      outlined
      single-line
      v-model="title"
    ...
    <div class="edit-area">
      ...
      <div v-html="compiledMarkdown(body)" class="preview"></div>
    </div>
...
export default {
  ...
  async created() {
    ...
    renderer.code = function (code, lang) {
      const _lang = lang ? lang.split(".").pop() : "";
      try {
  ...
  methods: {
    ...
    async fetchArticle(id) {
      // 下書き編集画面用なら /articles/drafts/:id
      // 公開記事編集画面なら /articles/:id に変える
      await axios
